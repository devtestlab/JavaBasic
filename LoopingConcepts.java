...
public class LoopingConcepts {
	...
	public static void main(String[] args) {
		...
		/*
		 * OUTPUT:
		 * WHILE LOOP FOR INCREMENTAL WAY OF PRINTING
			1
			2
			3
			4
			...
			9
			10
			WHILE LOOP FOR DECREMENTAL WAY OF PRINTING
			10
			9
			8
			7
			...
			2
			1
			FOR LOOP FOR INCREMENTAL WAY OF PRINTING
			1
			2
			3
			4
			...
			9
			10
			FOR LOOP FOR DECREMENTAL WAY OF PRINTING
			10
			9
			8
			7
